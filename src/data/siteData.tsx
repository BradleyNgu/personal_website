...
export const projects: Project[] = [
  {
    ...
    technologies: ['TypeScript', 'Kotlin', 'Python', 'JavaScript', 'Twilio', 'OpenAI', 'Expo', 'React Native'],
  ...
  },
  {
    ...
    githubLink: 'https://github.com/BradleyNgu/uOttaHack-8',
    playLink: 'https://arcticargus.xyz',
